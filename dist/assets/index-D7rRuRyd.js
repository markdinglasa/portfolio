const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-D2hOFMkR.js","assets/mui-DIWVWDsQ.js","assets/react-C5GD-hyb.js","assets/index-B61sKQxo.js","assets/mdi-DKqkPJ5s.js","assets/styles-CRRCSI1g.js","assets/uitls-Cm9REV1f.js","assets/index-CeS91Sjv.css"])))=>i.map(i=>d[i]);
import{P as c,D as l,C as d,a as m,c as p,_ as x}from"./index-B61sKQxo.js";import{j as e,S as i}from"./mui-DIWVWDsQ.js";import{a as n}from"./react-C5GD-hyb.js";import{y as t}from"./styles-CRRCSI1g.js";const f=[{icon:c,title:"Mobile Application",description:"Building mobile applications that combine seamless functionality with an exceptional user experience."},{icon:l,title:"Responsive Web Application",description:"Crafting responsive web designs that adapt beautifully to every screen and enhance user engagement."},{icon:d,title:"Desktop Application",description:"Delivering powerful and user-friendly desktop solutions tailored for efficiency and innovation."},{icon:m,title:"UI/UX",description:"Creating user-centric designs that are seamless, impactful, and delightful to experience."}],h=t.div`
  overflow: visible;
  width: 100%;
  height: 20rem;
  border-radius: 20px;
