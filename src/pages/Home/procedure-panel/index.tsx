    ...
    <>
      ...
      >
        <div className="w-full h-fit md:w-10/12 content flex flex-wrap md:flex-row gap-4  overflow-visible relative md:px-0 px-4">
          ...
          <div className="flex md:flex-row sm:flex-col flex-col items-center justify-between gap-4 w-full py-4 overflow-visible ">
              ...
              <Fragment key={index}>
                <>
                  <div
                    ...
                    className={`${active?.title === data.title ? "text-[#e9c6a9] -mt-[0.5rem] " : ""} shadow-2xl border border-slate-100/10 hover:border-[#e9c6a9] w-full md:w-[15rem] md:h-[15rem] h-fit bg-[#161616] rounded-[20px] p-4 flex flex-col hover:-mt-[0.5rem] duration-300 ease-linear hover:text-[#e9c6a9] text-[#9C9C9C] cursor-pointer`}
                  >
                    ...
                    <div className="flex w-full items-center justify-center py-2 h-[7rem] overflow-visible text-center">
                      <span className="ms:text-xl text-2xl text-[#9C9C9C] font-bold uppercase">
                        {data.title}
                      </span>
                    </div>
          ...
          >
            <div
              className={`w-full  h-fit  overflow-visible rounded-md p-[1rem] flex-row shadow-md`}
            >
              <div className="header  w-full flex flex-row justify-between gap-4 border-b pb-2 border-slate-100/40">
                <div className="flex flex-col md:flex-row gap-4">
                  ...
                  <div className="flex flex-col items-start justify-center">
                    <span className="text-2xl ">{active?.alias}</span>
