...
export const ServicePage: SFC = ({ ClassName }) => {
  return (
    <>
      ...
      >
        <div className="w-full md:w-10/12 flex justify-center items-center flex-col ">
          ...
          <div className="w-full flex flex-col lg:flex-row justify-center md:justify-start items-center md:items-start gap-4   overflow-visible py-[5rem] px-2">
