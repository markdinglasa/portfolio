...
export const Footer: SFC = ({ ClassName }) => {
  ...
  return (
    <>
      <S.Container
        className={cn(
          "p-3 rounded-lg border border-gray-100/30 flex md:flex-row flex-col justify-between items-center w-full md:w-10/12 mb-[3rem] md:mb-0",
          ClassName
        )}
      >
        <S.Span className="text-sm text-[#9C9C9C]">
          Mark Dinglasa &copy; 2025 All rights reserved{" "}
        </S.Span>
